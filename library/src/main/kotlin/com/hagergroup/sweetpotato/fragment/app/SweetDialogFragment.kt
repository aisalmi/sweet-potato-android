 ...
 * @since 2018.11.07
 */
abstract class SweetDialogFragment<AggregateClass : SweetFragmentAggregate>
  : DialogFragment(),
    Sweetable<AggregateClass>
{

  private var sweetizer: Sweetizer<AggregateClass, SweetDialogFragment<AggregateClass>>? = null
